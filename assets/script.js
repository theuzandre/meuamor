$(document).ready(function(){
    ...
    const mostraMsgMes = (texto) =>{
        ...
        switch(texto){
            ...
            case "6/1": titulo = "06 de Janeiro de 2023"; mensagem = "<p>Foi o primeiro dia que cantamos juntos.<br> Foi o primeiro dia que realmente falamos um para o outro que realmente estávamos apaixonados usado a letra da música sozinha de Caetano Veloso: <br> As vezes no silêncio da noite <br> Eu fico imaginando nós dois <br> Eu fico ali sonhando acordado.<br> Você tinha acabado de cantar ela para mim.❤️</p>";break;
            case "7/1": titulo = "07 de Janeiro de 2023"; mensagem = "<p>Foi o primeiro dia que andamos juntos .<br>Você estava linda, usando um vestido preto com um relogio que tem.<br>Eu estava no culto ao livre da Hebrom, mas combinamos de se ver, onde fiz sua primeira cartinha. marcamos de se encontrar na eletrozema, e chegando lá você estava cheia de sacola, e eu ajudei a levar. passei perto do seu reino hahaha princesinha.❤️</p>";break;
            case "24/1": titulo = "24 de Janeiro de 2023"; mensagem = "<p>Foi o dia que começamos namorar e orar juntos, para o nosso namoro ser abençoado por Deus.<br>Onde tudo começou dar certo, ficamos tão ansiosos esse dia que nem sabemos como começava, mas oramos é ficamos tão alegre quando sentimos a presença do Senhor em nosso relacionamento, como eu amei esse dia!!</p>";break;
            case "28/1": titulo = "28 de Janeiro de 2023"; mensagem = "<p>Foi o dia do nosso primeiro beijinho onde eu estava querendo te beijar, e antes você me beijou isso foi tão incrível para mim, você com o vestido da virada eu com a blusa da virada hahaha.<br>Nosso primeiro beijo teve cara de nosso primeiro encontro, e ainda subimos para a noite de adoração tão felizes de mãos dadas!!</p>";break;
            case "1/4": titulo = "01 de Abril de 2023"; mensagem = "<p>Esse dia foi tão especial, saíamos para tomar sorvete depois do encontro com Maria, você não conseguindo tomar o sorvete todo kkkkk, mas enfim tomou, depois disso subimos para a Matriz enquanto sua mamis e Karine arrumava as coisas da supresa, lá foi totalmente incrível cara!!<br> Você me fazendo carinho foi tão especial para mim, o jeitinho que você me tratou na matriz foi extremamente lindo e gostoso de sentir.!! <br> Seu abraço, seu cheirinho foi tão incrível de sentir e ter.<br> Você é tão preciosa minha querida!!</p>";break;
            case "final": titulo = "24 de Março de 2023"; mensagem = "<section class='text-center mt-5 mb-5'><p><strong>O dia em que completamos 3 MESES, é ela disse que me AMA!!<br><span class='letra2 letra-vermelha'>SIM</span></strong></p></section>";break;
        }
